...
pub mod player {
    ...
    #[macro_export]
    macro_rules ! _include_player { ($ (($ ($ func_arg : ident : $ func_arg_ty : ty) , +) =>) ? $ module_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { # [allow (warnings)] pub mod $ module_name { crate :: prisma :: player :: include ! (@ definitions ; $ module_name ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; use super :: * ; pub struct Selection (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: IncludeType for Selection { type Data = Data ; type ModelData = crate :: prisma :: player :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } pub fn include ($ ($ ($ func_arg : $ func_arg_ty) , +) ?) -> Selection { Selection ([crate :: prisma :: player :: include ! (@ selections_to_params ; : include { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ()) . collect :: < Vec < _ >> () , < crate :: prisma :: player :: Types as :: prisma_client_rust :: ModelTypes > :: scalar_selections ()] . into_iter () . flatten () . collect :: < Vec < _ >> ()) } } } ; ({ $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { { crate :: prisma :: player :: include ! (@ definitions ; ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; pub struct Selection (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: IncludeType for Selection { type Data = Data ; type ModelData = crate :: prisma :: player :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } Selection ([crate :: prisma :: player :: include ! (@ selections_to_params ; : include { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ()) . collect :: < Vec < _ >> () , < crate :: prisma :: player :: Types as :: prisma_client_rust :: ModelTypes > :: scalar_selections ()] . into_iter () . flatten () . collect :: < Vec < _ >> ()) } } ; (@ definitions ; $ ($ module_name : ident) ? ; $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) +) => { # [allow (warnings)] enum Fields { } # [allow (warnings)] impl Fields { fn selections () { $ (let _ = Fields :: $ field ;) + } } # [allow (warnings)] # [derive (std :: fmt :: Debug , Clone)] pub struct Data { pub steam : String , pub name : String , pub value : i32 , pub rank : i32 , pub kills : i32 , pub deaths : i32 , pub shoots : i32 , pub hits : i32 , pub headshots : i32 , pub assists : i32 , pub round_win : i32 , pub round_lose : i32 , pub playtime : i32 , pub lastconnect : i32 , $ (pub $ field : crate :: prisma :: player :: include ! (@ field_type ; $ field $ (: $ selection_mode { $ ($ selections) + }) ?) ,) + } impl :: serde :: Serialize for Data { fn serialize < S > (& self , serializer : S) -> Result < S :: Ok , S :: Error > where S : :: serde :: Serializer , { use :: serde :: ser :: SerializeStruct ; let mut state = serializer . serialize_struct ("Data" , [$ (stringify ! ($ field) ,) + stringify ! (steam) , stringify ! (name) , stringify ! (value) , stringify ! (rank) , stringify ! (kills) , stringify ! (deaths) , stringify ! (shoots) , stringify ! (hits) , stringify ! (headshots) , stringify ! (assists) , stringify ! (round_win) , stringify ! (round_lose) , stringify ! (playtime) , stringify ! (lastconnect)] . len ()) ? ; $ (state . serialize_field (crate :: prisma :: player :: $ field :: NAME , & self . $ field) ? ;) * state . serialize_field (crate :: prisma :: player :: steam :: NAME , & self . steam) ? ; state . serialize_field (crate :: prisma :: player :: name :: NAME , & self . name) ? ; state . serialize_field (crate :: prisma :: player :: value :: NAME , & self . value) ? ; state . serialize_field (crate :: prisma :: player :: rank :: NAME , & self . rank) ? ; state . serialize_field (crate :: prisma :: player :: kills :: NAME , & self . kills) ? ; state . serialize_field (crate :: prisma :: player :: deaths :: NAME , & self . deaths) ? ; state . serialize_field (crate :: prisma :: player :: shoots :: NAME , & self . shoots) ? ; state . serialize_field (crate :: prisma :: player :: hits :: NAME , & self . hits) ? ; state . serialize_field (crate :: prisma :: player :: headshots :: NAME , & self . headshots) ? ; state . serialize_field (crate :: prisma :: player :: assists :: NAME , & self . assists) ? ; state . serialize_field (crate :: prisma :: player :: round_win :: NAME , & self . round_win) ? ; state . serialize_field (crate :: prisma :: player :: round_lose :: NAME , & self . round_lose) ? ; state . serialize_field (crate :: prisma :: player :: playtime :: NAME , & self . playtime) ? ; state . serialize_field (crate :: prisma :: player :: lastconnect :: NAME , & self . lastconnect) ? ; state . end () } } impl < 'de > :: serde :: Deserialize < 'de > for Data { fn deserialize < D > (deserializer : D) -> Result < Self , D :: Error > where D : :: serde :: Deserializer < 'de > , { # [allow (warnings)] enum Field { $ ($ field) , + , steam , name , value , rank , kills , deaths , shoots , hits , headshots , assists , round_win , round_lose , playtime , lastconnect } impl < 'de > :: serde :: Deserialize < 'de > for Field { fn deserialize < D > (deserializer : D) -> Result < Field , D :: Error > where D : :: serde :: Deserializer < 'de > , { struct FieldVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for FieldVisitor { type Value = Field ; fn expecting (& self , formatter : & mut :: std :: fmt :: Formatter) -> :: std :: fmt :: Result { formatter . write_str (& [$ (crate :: prisma :: player :: $ field :: NAME) , + , crate :: prisma :: player :: steam :: NAME , crate :: prisma :: player :: name :: NAME , crate :: prisma :: player :: value :: NAME , crate :: prisma :: player :: rank :: NAME , crate :: prisma :: player :: kills :: NAME , crate :: prisma :: player :: deaths :: NAME , crate :: prisma :: player :: shoots :: NAME , crate :: prisma :: player :: hits :: NAME , crate :: prisma :: player :: headshots :: NAME , crate :: prisma :: player :: assists :: NAME , crate :: prisma :: player :: round_win :: NAME , crate :: prisma :: player :: round_lose :: NAME , crate :: prisma :: player :: playtime :: NAME , crate :: prisma :: player :: lastconnect :: NAME] . into_iter () . collect :: < Vec < _ >> () . join (", ")) } fn visit_str < E > (self , value : & str) -> Result < Field , E > where E : :: serde :: de :: Error , { match value { $ (crate :: prisma :: player :: $ field :: NAME => Ok (Field :: $ field)) , * , crate :: prisma :: player :: steam :: NAME => Ok (Field :: steam) , crate :: prisma :: player :: name :: NAME => Ok (Field :: name) , crate :: prisma :: player :: value :: NAME => Ok (Field :: value) , crate :: prisma :: player :: rank :: NAME => Ok (Field :: rank) , crate :: prisma :: player :: kills :: NAME => Ok (Field :: kills) , crate :: prisma :: player :: deaths :: NAME => Ok (Field :: deaths) , crate :: prisma :: player :: shoots :: NAME => Ok (Field :: shoots) , crate :: prisma :: player :: hits :: NAME => Ok (Field :: hits) , crate :: prisma :: player :: headshots :: NAME => Ok (Field :: headshots) , crate :: prisma :: player :: assists :: NAME => Ok (Field :: assists) , crate :: prisma :: player :: round_win :: NAME => Ok (Field :: round_win) , crate :: prisma :: player :: round_lose :: NAME => Ok (Field :: round_lose) , crate :: prisma :: player :: playtime :: NAME => Ok (Field :: playtime) , crate :: prisma :: player :: lastconnect :: NAME => Ok (Field :: lastconnect) , _ => Err (:: serde :: de :: Error :: unknown_field (value , FIELDS)) , } } } deserializer . deserialize_identifier (FieldVisitor) } } struct DataVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for DataVisitor { type Value = Data ; fn expecting (& self , formatter : & mut std :: fmt :: Formatter) -> std :: fmt :: Result { formatter . write_str ("struct Data") } fn visit_map < V > (self , mut map : V) -> Result < Data , V :: Error > where V : :: serde :: de :: MapAccess < 'de > , { $ (let mut $ field = None ;) * let mut steam = None ; let mut name = None ; let mut value = None ; let mut rank = None ; let mut kills = None ; let mut deaths = None ; let mut shoots = None ; let mut hits = None ; let mut headshots = None ; let mut assists = None ; let mut round_win = None ; let mut round_lose = None ; let mut playtime = None ; let mut lastconnect = None ; while let Some (key) = map . next_key () ? { match key { Field :: steam => { if steam . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: player :: steam :: NAME)) ; } steam = Some (map . next_value () ?) ; } Field :: name => { if name . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: player :: name :: NAME)) ; } name = Some (map . next_value () ?) ; } Field :: value => { if value . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: player :: value :: NAME)) ; } value = Some (map . next_value () ?) ; } Field :: rank => { if rank . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: player :: rank :: NAME)) ; } rank = Some (map . next_value () ?) ; } Field :: kills => { if kills . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: player :: kills :: NAME)) ; } kills = Some (map . next_value () ?) ; } Field :: deaths => { if deaths . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: player :: deaths :: NAME)) ; } deaths = Some (map . next_value () ?) ; } Field :: shoots => { if shoots . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: player :: shoots :: NAME)) ; } shoots = Some (map . next_value () ?) ; } Field :: hits => { if hits . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: player :: hits :: NAME)) ; } hits = Some (map . next_value () ?) ; } Field :: headshots => { if headshots . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: player :: headshots :: NAME)) ; } headshots = Some (map . next_value () ?) ; } Field :: assists => { if assists . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: player :: assists :: NAME)) ; } assists = Some (map . next_value () ?) ; } Field :: round_win => { if round_win . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: player :: round_win :: NAME)) ; } round_win = Some (map . next_value () ?) ; } Field :: round_lose => { if round_lose . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: player :: round_lose :: NAME)) ; } round_lose = Some (map . next_value () ?) ; } Field :: playtime => { if playtime . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: player :: playtime :: NAME)) ; } playtime = Some (map . next_value () ?) ; } Field :: lastconnect => { if lastconnect . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: player :: lastconnect :: NAME)) ; } lastconnect = Some (map . next_value () ?) ; } $ (Field :: $ field => { if $ field . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: player :: $ field :: NAME)) ; } $ field = Some (map . next_value () ?) ; }) * } } $ (let $ field = $ field . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: player :: $ field :: NAME)) ? ;) * let steam = steam . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: player :: steam :: NAME)) ? ; let name = name . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: player :: name :: NAME)) ? ; let value = value . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: player :: value :: NAME)) ? ; let rank = rank . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: player :: rank :: NAME)) ? ; let kills = kills . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: player :: kills :: NAME)) ? ; let deaths = deaths . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: player :: deaths :: NAME)) ? ; let shoots = shoots . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: player :: shoots :: NAME)) ? ; let hits = hits . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: player :: hits :: NAME)) ? ; let headshots = headshots . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: player :: headshots :: NAME)) ? ; let assists = assists . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: player :: assists :: NAME)) ? ; let round_win = round_win . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: player :: round_win :: NAME)) ? ; let round_lose = round_lose . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: player :: round_lose :: NAME)) ? ; let playtime = playtime . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: player :: playtime :: NAME)) ? ; let lastconnect = lastconnect . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: player :: lastconnect :: NAME)) ? ; Ok (Data { steam , name , value , rank , kills , deaths , shoots , hits , headshots , assists , round_win , round_lose , playtime , lastconnect , $ ($ field) , * }) } } const FIELDS : & 'static [& 'static str] = & ["steam" , "name" , "value" , "rank" , "kills" , "deaths" , "shoots" , "hits" , "headshots" , "assists" , "round_win" , "round_lose" , "playtime" , "lastconnect"] ; deserializer . deserialize_struct ("Data" , FIELDS , DataVisitor) } } $ ($ (pub mod $ field { crate :: prisma :: player :: $ selection_mode ! (@ field_module ; $ field : $ selection_mode { $ ($ selections) + }) ; }) ?) + } ; (@ field_type ; $ field : ident $ ($ tokens : tt) *) => { compile_error ! (stringify ! (Cannot include nonexistent relation $ field on model "Player" , available relations are "")) } ; (@ field_module ; $ ($ tokens : tt) *) => { } ; (@ selection_field_to_selection_param ; $ ($ tokens : tt) *) => { compile_error ! (stringify ! ($ ($ tokens) *)) } ; (@ selections_to_params ; : $ macro_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { [$ (crate :: prisma :: player :: $ macro_name ! (@ selection_field_to_selection_param ; $ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) ,) +] } ; (@ filters_to_args ;) => { vec ! [] } ; (@ filters_to_args ; $ ($ t : tt) *) => { $ ($ t) * } ; (@ field_serde_name ; steam) => { "steam" } ; (@ field_serde_name ; name) => { "name" } ; (@ field_serde_name ; value) => { "value" } ; (@ field_serde_name ; rank) => { "rank" } ; (@ field_serde_name ; kills) => { "kills" } ; (@ field_serde_name ; deaths) => { "deaths" } ; (@ field_serde_name ; shoots) => { "shoots" } ; (@ field_serde_name ; hits) => { "hits" } ; (@ field_serde_name ; headshots) => { "headshots" } ; (@ field_serde_name ; assists) => { "assists" } ; (@ field_serde_name ; round_win) => { "round_win" } ; (@ field_serde_name ; round_lose) => { "round_lose" } ; (@ field_serde_name ; playtime) => { "playtime" } ; (@ field_serde_name ; lastconnect) => { "lastconnect" } ; }
    ...
    #[macro_export]
    macro_rules ! _partial_unchecked_player { ($ struct_name : ident { $ ($ scalar_field : ident) + }) => { :: prisma_client_rust :: macros :: partial_unchecked ! { crate :: prisma :: player struct $ struct_name { # [serde (rename = "steam")] pub steam : String , # [serde (rename = "name")] pub name : String , # [serde (rename = "value")] pub value : i32 , # [serde (rename = "rank")] pub rank : i32 , # [serde (rename = "kills")] pub kills : i32 , # [serde (rename = "deaths")] pub deaths : i32 , # [serde (rename = "shoots")] pub shoots : i32 , # [serde (rename = "hits")] pub hits : i32 , # [serde (rename = "headshots")] pub headshots : i32 , # [serde (rename = "assists")] pub assists : i32 , # [serde (rename = "round_win")] pub round_win : i32 , # [serde (rename = "round_lose")] pub round_lose : i32 , # [serde (rename = "playtime")] pub playtime : i32 , # [serde (rename = "lastconnect")] pub lastconnect : i32 } [$ ($ scalar_field) , +] } } ; }
